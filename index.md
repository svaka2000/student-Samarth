...
Hi! My name is Samarth Vaka. I am a student in AP Computer Science A with the Open Coding Society.
...
<div class="ocs__links ocs__links--wide">
    ...
    <a class="ocs__btn ocs__btn--icon alert-yellow" href="https://github.com/svaka2000/student-Samarth">
        <span class="ocs__btn-icon" aria-hidden="true">
